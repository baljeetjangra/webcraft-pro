...
export default function Home() {
  return (
    <>
      <section className="relative h-full w-full md:pt-52  flex items-center justify-center flex-col">
        ...
        <div className="flex justify-center items-center  gap-4 relative mt-[-20px] md:mt-[-50px]">
          <Image
            src="/assets/preview.png"
            alt="banner"
            width={1200}
            height={1200}
            className="rounded-tl-2xl border-2 rounded-tr-2xl border-muted"
          />
